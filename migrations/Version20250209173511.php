 ...
 */
final class Version20250209173511 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE operations (id INT AUTO_INCREMENT NOT NULL, route_id INT NOT NULL, operation_date DATE NOT NULL, direction ENUM(\'上り\', \'下り\') NOT NULL, status VARCHAR(50) DEFAULT NULL, status_text VARCHAR(50) DEFAULT NULL, arrival_time DATETIME DEFAULT NULL, departure_time DATETIME DEFAULT NULL, memo LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_2814534834ECB4E6 (route_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
